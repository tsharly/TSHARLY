...
local function check_member_super(cb_extra, success, result) 
  ...
  if success == 0 then 
   send_large_msg(receiver, "للأدمنيه والمدراء فقط لتلعب بكيفك ابني 🌝❤️") 
  end 
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
      ...
      save_data(_config.moderation.data, data) 
     local text = 'تم تــفعيل البــوت في المجموعه 🌝❤️' 
  ...
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
     -- Group configuration removal 
      ...
      save_data(_config.moderation.data, data) 
     local text = 'تـم تـعطيل البـوت في المـجمـوعتك 🌝❤️ ' 
      return reply_msg(msg.id, text, ok_cb, false) 
    end 
  end 
end 
...
local title ="اعدادات المجموعه 🌝❤️: ["..result.title.."]\n\n" 
local admin_num = "💫 عدد الادمنيه 🌝❤️: "..result.admins_count.."\n" 
local user_num = "💫 عدد  الاعضاء🌝❤️: "..result.participants_count.."\n" 
local kicked_num = "💫 الاعضاء الاكثر تفاعلٱ 🌝❤️: "..result.kicked_count.."\n" 
local channel_id = "💫 ايدي المجموعه 🆔🌝❤️: "..result.peer_id.."\n" 
if result.username then 
   channel_username = "💫 معرف المجموعه 🌝❤️: @"..result.username 
else 
   channel_username = "" 
end 
...
local text = "🌝❤️ اعضاء المجموعه ℹ"..cb_extra.receiver 
local i = 1 
for k,v in pairsByKeys(result) do 
...
--vardump(result) 
local text = "قائمة ايديات الاعضاء 🌝❤️"..cb_extra.receiver.."\n\n" 
local i = 1 
for k,v in pairsByKeys(result) do 
if not v.print_name then 
   name = " " 
...
local function lock_group_links(msg, data, target) 
  ...
  if group_link_lock == 'yes' then 
    return 'ℹ الروابط بالتاكيد تم✔ قفلها مسبقا 🌝❤️' 
  else 
    data[tostring(target)]['settings']['lock_link'] = 'yes' 
    save_data(_config.moderation.data, data) 
return 'تـم قفـل الـروابط عـزيـزي 🔒✔️'
end 
...
local function unlock_group_links(msg, data, target) 
  ...
  if group_link_lock == 'no' then 
    return 'تـم فتـح الـروابط مـسبقـاََ 🌝✔️' 
  else 
    data[tostring(target)]['settings']['lock_link'] = 'no' 
    save_data(_config.moderation.data, data) 
    return 'تـم فتـح الـروابط عـزيزي 🌝✔️' 
  end 
end 
...
local function lock_group_spam(msg, data, target) 
  ...
  if not is_owner(msg) then 
    return "لا يمكـنك التحـكم بـي لانـك عـضو 🌝😹" 
  end 
  local group_spam_lock = data[tostring(target)]['settings']['lock_spam'] 
  if group_spam_lock == 'yes' then 
    return 'تـم تفعيـل مـضاد السـبام مسـبقاََ 🌝❤️' 
  else 
    data[tostring(target)]['settings']['lock_spam'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return 'تـم تعطيـل مضـاد الســبام 🌝❎' 
  end 
end 
...
local function unlock_group_spam(msg, data, target) 
  ...
  if group_spam_lock == 'no' then 
    return 'تـم تفـعيل مضـاد السـبام مسبقاََ 🌝❤️' 
  else 
    data[tostring(target)]['settings']['lock_spam'] = 'no' 
    save_data(_config.moderation.data, data) 
    return 'تـم تفعيـل مـضاد السـبام 🌝❤️' 
  end 
end 
...
local function lock_group_flood(msg, data, target) 
  ...
  if group_flood_lock == 'yes' then 
    return 'تـم قفـل التـكرار مسـبقاََ 🌝❤️' 
  else 
    data[tostring(target)]['settings']['flood'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return 'تـم قفـل التكـرار 🌝❤️' 
  end 
end 
...
local function enable_strict_rules(msg, data, target) 
  ...
  if group_strict_lock == 'yes' then 
    return 'تم بالفعل ✔️ قفل 🔐 جميع الاعدادات 🌝❤️' 
  else 
    data[tostring(target)]['settings']['strict'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return 'تم ️ قفل ℹ جميع الاعدادات ✔' 
  end 
end 
...
local function set_public_membermod(msg, data, target) 
  if not is_momod(msg) then 
    return "✘ ليس لك صلاحيه التحكم في البوت للمدرء والادمنيه فقط🌞😂" 
  end 
...
local function promote_admin(receiver, member_username, user_id) 
  ...
  if data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_username..'بالتاكيد تم ✔ رفعه ادمن في المجموعه 🌝❤️') 
  end 
...
local function promote2(receiver, member_username, user_id) 
  ...
  local member_tag_username = string.gsub(member_username, '@', '(at)') 
  if not data[group] then 
    return send_large_msg(receiver, 'الـمـٰ۫ﮩ๋͜ﮧـ͜ާـجــේـمــوعہهہ┋ ✋✨℡ لم ينت تفعيلها 🌝❤️') 
  end 
  if data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_username..'بالتاكيد تم ✔ رفع ادمن  في المجموعه 🌝❤️') 
  end 
  data[group]['moderators'][tostring(user_id)] = member_tag_username 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..'♯تم ✔ رفعك ادمن في المجموعه ☹') 
end 
...
local function demote2(receiver, member_username, user_id) 
  ...
  local group = string.gsub(receiver, 'channel#id', '') 
  if not data[group] then 
    return 'الـمـٰ۫ﮩ๋͜ﮧـ͜ާـجــේـمــوعہهہ┋ ✋✨℡ لم يتم تفعيلها 🌝❤️' 
  end 
  if not data[group]['moderators'][tostring(user_id)] then 
     return send_large_msg(receiver, member_username..'بالتاكيد تم ✔ تنزيله منه قائمة الادمنيه ☹') 
  end 
  data[group]['moderators'][tostring(user_id)] = nil 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..'تم ✔ تنزيلك من قائمه الادمنيه 🌝😹') 
end 
...
local function modlist(msg) 
  ...
  if next(data[tostring(msg.to.id)]['moderators']) == nil then 
    return 'لم ✘ يتم ☠ العثور على ادمنيه في المجموعه ☻️' 
  end 
  local i = 1 
...
function get_message_callback(extra, success, result) 
   ...
   elseif get_cmd == 'ايدي' and result.action then 
    ...
    if is_momod2(member_id, channel_id) and not is_admin2(msg.from.id) then 
            return send_large_msg("channel#id"..channel_id, "لا يمكنك ☠ طرد الادمنيه 🌝❤️ والمدراء ☹ ") 
    end 
    if is_admin2(member_id) then 
         return send_large_msg("channel#id"..channel_id, "ليست ☠ لديك صلاحيه طرد اداري من المجموعه ☹") 
    end 
   ...
   elseif get_cmd == 'channel_block' and result.action and result.action.type == 'chat_add_user' then 
    ...
    if is_momod2(member_id, channel_id) and not is_admin2(msg.from.id) then 
            return send_large_msg("channel#id"..channel_id, "لا يمكنك ☠ طرد الاداريين ☄ والمدراء 🌝❤️ ") 
    end 
    if is_admin2(member_id) then 
         return send_large_msg("channel#id"..channel_id, "ليست☠ لديك صلاحيه طرد ☹ اداري  ") 
    end 
   ...
   elseif get_cmd == "رفع اداري" then 
      ...
      if result.from.username then 
         text = "@"..result.from.username.."تم ✔ ترقيتك 🌝❤️ اداري  في المجموعه 🌝" 
      else 
   ...
   elseif get_cmd == "تنزيل اداري" then 
      ...
      if is_admin2(result.from.peer_id) then 
         return send_large_msg(channel_id, "ليست ☠ لديك ✘ صلاحيه تنزيل اداراي 🌝❤️") 
      end 
      channel_demote(channel_id, "user#id"..user_id, ok_cb, false) 
      if result.from.username then 
         text = "@"..result.from.username.."تم ✔ تنزيلك من قائمة الادمنيه ☹☻" 
      else 
         text = "[ "..user_id.." ] تم ✔ تنزيلك من قائمة الادمنيه ☹♯" 
      end 
   ...
   elseif get_cmd == 'mute_user' then 
      ...
      if is_muted_user(chat_id, user_id) then 
         ...
         send_large_msg(receiver, "["..user_id.."] ضليت تكمز 🌝 اهر شي كتموك تستاهل 😂😂") 
      elseif is_admin1(msg) then 
         mute_user(chat_id, user_id) 
         send_large_msg(receiver, " ["..user_id.."] ضليت 🌝 تكمز اخر شي كتموك تستاهل 😂😂") 
      end 
   end 
end 
...
local function cb_user_info(extra, success, result) 
   ...
   if get_cmd == "تنزيل اداري" then 
      if is_admin2(result.peer_id) then 
         return send_large_msg(receiver, "ليست ☠ لديك صلاحيه تنزيل الادمينه والمدراء 🌝❤️") 
      end 
      local user_id = "user#id"..result.peer_id 
...
local function callbackres(extra, success, result) 
  ...
  local get_cmd = extra.get_cmd 
   if get_cmd == "ايدي" then 
      local user = result.peer_id 
      local name = string.gsub(result.print_name, "_", " ") 
      local channel = 'channel#id'..extra.channelid 
      send_large_msg(channel, user..'\n'..name) 
      return user 
   elseif get_cmd == "ايدي الكروب" then 
      local user = result.peer_id 
      local channel = 'channel#id'..extra.channelid 
      send_large_msg(channel, user) 
      return user 
  elseif get_cmd == "invite" then 
   ...
   elseif get_cmd == "تنزيل اداري" then 
      ...
      local channel_id = extra.channel 
      if is_admin2(result.peer_id) then 
         return send_large_msg(channel_id, "ليست  ☠ لديك صلاحيه تنزيل اداري ☹") 
      end 
      channel_demote(channel_id, user_id, ok_cb, false) 
      if result.username then 
         text = "@"..result.username.."  تم ✔ تنزيلك من قائمه الادارين في المجموعه ☹" 
         send_large_msg(channel_id, text) 
      else 
         text = "@"..result.peer_id.."   تم ✔ تنزيلك من قائمة الادارين في المجموعه ☹" 
         send_large_msg(channel_id, text) 
      end 
      local receiver = extra.channel 
      local user_id = result.peer_id 
    ...
    if vusername == member or vpeer_id == memberid then 
     ...
     local sender = cb_extra.msg.from.id 
      ...
      if is_momod2(user_id, channel_id) and not is_admin2(sender) then 
        return send_large_msg("channel#id"..channel_id, "ليست ☠ لديك صلاحيه ☹ طرد الادمنيه والمدراء 🌝❤️") 
      end 
...
elseif get_cmd == "رفع اداري" then 
   for k,v in pairs(result) do 
    ...
    if vusername == member or vpeer_id == memberid then 
      ...
      channel_set_admin(channel_id, user_id, ok_cb, false) 
      if v.username then 
        text = "@"..v.username.." ["..v.peer_id.."]  تم ✔ ترقيتك اداري في المجموعه ☹" 
        savelog(msg.to.id, name_log.." ["..msg.from.id.."] set admin @"..v.username.." ["..v.peer_id.."]") 
      else 
        text = "["..v.peer_id.."]   تم ✔ ترقيتك اداري في المجموعه ☹" 
   ...
   for k,v in pairs(result) do 
      ...
      if vusername == member or vpeer_id == memberid then 
         ...
         if group_owner then 
            ...
            if result.username then 
               text = member_username.." ["..v.peer_id.."]  تم ✔ ترقيتك مدير المجموعه ☹" 
            else 
               text = "["..v.peer_id.."]  تم✔ ترقيتك مدير المجموعه ☹" 
            end 
         end 
      elseif memberid and vusername ~= member and vpeer_id ~= memberid then 
         ...
         if group_owner then 
            ...
            text = "["..memberid.."]  تم✔ ترقيتك مدير المجموعه ☹" 
         end 
      end 
   end 
 end 
   ...
   local data = load_data(_config.moderation.data) 
      if matches[1] == 'تفعيل' and not matches[2] then 
         ...
         if is_super_group(msg) then 
            return reply_msg(msg.id, '♯بالتاكيد تم ✔تفعيل البوت في المجموعه☹َ', ok_cb, false) 
         end 
      ...
      if matches[1] == 'تعطيل' and is_admin1(msg) and not matches[2] then         if not is_super_group(msg) then 
            return reply_msg(msg.id, 'تم ✔ تعطيل البوت في المجموعه ☻️', ok_cb, false) 
         end 
      ...
      if matches[1] == "مدير المجموعه" then 
         ...
         if not group_owner then 
            return "  لم يتم تعيين مدير المجموعه 🌞☹" 
         end 
      ...
      if msg.text then 
         if msg.text:match("^(https://telegram.me/joinchat/%S+)$") and data[tostring(msg.to.id)]['settings']['set_link'] == 'waiting' and is_owner(msg) then 
            ...
            save_data(_config.moderation.data, data) 
            return "تم ✔️ حفظ الرابط المجموعه ☹" 
         end 
      end 
      ...
      if matches[1] == 'الرابط' then 
         ...
         if not group_link then 
            return "يرجى ارسال ❗♯ ️تغير الرابط   🌝❤️ لانشاء 🌝 رابط المجموعه ✍" 
         end 
      ...
      if matches[1] == 'يداي' and is_owner(msg) then 
         local cbres_extra = { 
            channelid = msg.to.id, 
            get_cmd = 'ادي' 
         } 
      ...
      if matches[1] == 'رفع مدير' and is_owner(msg) then 
         ...
         elseif matches[1] == 'رفع مدير' and string.match(matches[2], '^%d+$') then 
      --[[   local group_owner = data[tostring(msg.to.id)]['set_owner'] 
            if group_owner then 
               local receiver = get_receiver(msg) 
            ...
            local user_id = matches[2] 
            channel_get_users (receiver, in_channel_cb, {get_cmd=get_cmd, receiver=receiver, msg=msg, user_id=user_id}) 
         elseif matches[1] == 'رفع مدير' and not string.match(matches[2], '^%d+$') then 
      ...
      if matches[1] == 'رفع ادمن' then 
        if not is_momod(msg) then 
         ...
         if not is_owner(msg) then 
            return "☠ لتلعب بكيفك هاذا الامر اللدمنيه والمدراء☹ فقط 🌞" 
         end 
         if type(msg.reply_id) ~= "nil" then 
            local cbreply_extra = { 
               get_cmd = 'رفع ادمن', 
      ...
      if matches[1] == 'تنزيل ادمن' then 
         ...
         if not is_owner(msg) then 
            return "☠ لتلعب بكيفك للمدراء والادمنيه☄ فقط ☹" 
         end 
         if type(msg.reply_id) ~= "nil" then 
            local cbreply_extra = { 
               get_cmd = 'تنزيل ادمن', 
      ...
      if matches[1] == "ضع معرف" and is_admin1(msg) then 
         local function ok_username_cb (extra, success, result) 
            ...
            elseif success == 0 then 
               send_large_msg(receiver, "فشل ☠ تعين ☹✘ معرف ❌ المجموعه 🌞️\nUsername may already be taken.\n\nNote: Username can use a-z, 0-9 and underscores.\nMinimum length is 5 characters.") 
            end 
         end 
         local username = string.gsub(matches[2], '@', '') 
      ...
      if matches[1] == 'مسح' then 
         ...
         if matches[2] == 'القوانين' then 
            ...
            if data[tostring(msg.to.id)][data_cat] == nil then 
               return "عذرٱ ☠️ لا يوجد ✘ قوانين 📋 في المجموعه 🎈 ليتم مسحه" 
            end 
         ...
         if matches[2] == 'الوصف' then 
            ...
            local data_cat = 'description' 
            if data[tostring(msg.to.id)][data_cat] == nil then 
               return 'عذرٱ ☹ لا يوجد وصف 📃 في المجموعه  ليتم ☠مسحه ' 
            end 
            data[tostring(msg.to.id)][data_cat] = nil 
            save_data(_config.moderation.data, data) 
         ...
         if matches[2] == 'المكتومين' then 
            ...
            local hash =  'mute_user:'..chat_id 
               redis:del(hash) 
            return "تم ✔ مسح 🌝❤️ قائمه المكتومين ☹" 
         end 
      ...
      if matches[1] == 'فتح' and is_momod(msg) then 
         ...
         local msg_type = 'Text' 
            if is_muted(chat_id, msg_type..': yes') then 
               ...
               unmute(chat_id, msg_type) 
               return msg_type.."تم ✔️ فتح 🔓 الدردشه" 
            else 

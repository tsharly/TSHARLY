...
hash = 'channel:'..chat_id..':users' 
  ...
  return arian 
   ...
   local function rsusername_cb(extra, success, result) 
    ...
    return send_large_msg(chatid, "ٴٴ♚ ┋⇝ اسمكٌـﮧ الكـۂ͜ާـ‏امُــل هـৡـوو﴾℡☻: "..name.."\n🔘جميـًـًع رسـًائًلكہ المرسـًلةةفہـًي المجموعـًـًـًـًہِْةة ✘ هّہـيْۜ╋ِ🌝💛: "..msgss.." ("..round2(percent).."%)\n 🔘 عدد الرسِّــُஓـاٱئل التي تـ†ــِّم ارسالهـا✟͡  من قبلكہٖہٰ هہي ֆ ̮⇣☻: "..r.."                      ~ تابــع قنَہۧۧاتنا ليصلكٰہٰٰཻٖـٰٰـہٰٴكـْل مـاهـووֆᵛ͢ᵎᵖ﴾ @DEV_NOVAR ") 

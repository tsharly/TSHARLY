...
local function list_all_plugins(only_enabled) 
  ...
  local text = text..'\n آلَمۣۗہلَفۣۗہآتۣۗہ آلَمۣۗہثۣۗہبۣۗہتۣۗہة✔🔰📨. '..nsum..'\nآلَمۣۗہلَفۣۗہآآ آلَمۣۗہفۣۗہعۣۗہة🔰💭 ✔️ .'..nact..'\nآلَمۣۗہلَفۣۗہآتۣۗہ غۣۗہيۣۗہر مۣۗہفۣۗہعۣۗہلَهۣۗ🚫🔰📨'..nsum-nact..'' 
  return text 
end 
...
local function enable_plugin( plugin_name ) 
  ...
  if plugin_enabled(plugin_name) then 
    return 'اَلَمۣۗہلَفۣۗہ 📨 '..plugin_name..' مۣۗہفۣۗہعۣۗہلَ️' 
  end 
  ...
  if plugin_exists(plugin_name) then 
    ...
    return ''..plugin_name..' لَمۣۗہ يۣۗہتۣۗہمۣۗہ آلَعۣۗہثۣۗہوۣر عۣۗہلَى آسۣۗہمۣۗہ آلَمۣۗہلَفۣۗہ 🌚🔰📑 ' 
  end 
end 
...
local function disable_plugin( name, chat ) 
  ...
  if not plugin_exists(name) then 
    return ''..name..' لَمۣۗہ يۣۗہتۣۗہمۣۗہ آلَثۣۗہوۣر عۣۗہلَى آسۣۗہمۣۗہ آلَمۣۗہلَفۣۗہ🌚🔰📑' 
  end 
  local k = plugin_enabled(name) 
  -- Check if plugin is enabled 
  if not k then 
    return 'آلَمۣۗہلَفۣۗہ 📑 '..name..'غۣۗہيۣۗہر مۣۗہفۣۗہعۣۗہلَ 🚫📨' 
  end 
  -- Disable and reload 

...
local function run (msg, matches) 
  ...
  return 'تہٍـِـِۣـّ̐ہٰم  ِِِ ✾❣قہٍّْـٍّْ﴿🔐﴾ٍّْـفہلٍٍّّْْ ﭑضـــٰٰـॡۣۛﭑإ́فۂ͜ާـہ بـ✍ـﮩٍّﮩٍّﮩٍّـ✍ـﮩٍّوتات✿❥' 
  end 
  if matches[1] == 'فتح البوتات' then 
    disableAntiBot(chatId) 
  return 'تہٍـِـِۣـّ̐ہٰم  ِِ ✾❣فہٍّْـٍّْ﴿🔓﴾ٍّْـتہح❣ﭑضـــٰٰـॡۣۛﭑإ́فۂ͜ާـہ بـ✍ـﮩٍّﮩٍّﮩٍّـ✍ـﮩٍّوتات✿❥' 
  end 

...
VOLUNTARYCHECK=0
I=1
BOT=TSHARLY # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
EOF
echo -e "               \e[100m                TSHARLY script            \e[00;37;40m"
echo -e "               \e[01;34m              CH > @DEVASL          \e[00;37;40m"
echo ""
cat << EOF
 $f1 @PHPLUA  
EOF
...
echo ""
echo -e "\033[38;5;208m             CH  : @DEVASL                               \033[0;00m"
echo -e "\033[38;5;208m             DEV : @PHPLUA                  \033[0;00m"
echo -e "\033[38;5;208m             DEV : @PHPLUA                      \033[0;00m"
...
echo -e "\033[38;5;208m       CH  : @DEVASL                                    \033[0;00m"
echo -e "\033[38;5;208m       DEV : @PHPLUA                          \033[0;00m"
TSHARLYecho -e "\033[38;5;208m       DEV : @PHPLUA   \033[0;00m"
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1.2 iicc 2017 DEVASLTeam" >&2
	echo ""
	echo -e "\e[0m"
echo -e "\033[38;5;208m       CH  : @DEVASL         \033[0;00m"
echo -e "\033[38;5;208m       DEV : @PHPLUA         \033[0;00m"
